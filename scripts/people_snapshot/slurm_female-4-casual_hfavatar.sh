#!/bin/bash
#SBATCH --job-name=female-4-casual
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
exp_comment=`date +%s`
run_name="Peoplesnapshot-female-4-casual_${exp_comment}_slurm_${user_comment}"
base_exp_dir="exp/${run_name}"
conf="confs/hfavatar-people_snapshot/PeopleSnapshot-female-4-casual-mono-4gpus.conf"
