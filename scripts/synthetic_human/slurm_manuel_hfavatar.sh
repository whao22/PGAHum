...
exp_comment=`date +%s`
run_name="SyntheticHuman-manuel_${exp_comment}_slurm_${user_comment}"
base_exp_dir="exp/${run_name}"
conf="confs/hfavatar-synthetic_human/SyntheticHuman-manuel-4gpus.conf"
