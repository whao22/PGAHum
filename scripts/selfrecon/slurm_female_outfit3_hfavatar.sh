#!/bin/bash
#SBATCH --job-name=female_outfit3
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
exp_comment=`date +%s`
run_name="SelfreconSynthesis-female_outfit3_${exp_comment}_slurm_${user_comment}"
base_exp_dir="exp/${run_name}"
conf="confs/hfavatar-selfrecon_synthesis/SelfreconSynthesis-female-outfit3-mono-4gpus.conf"
