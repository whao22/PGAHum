#!/bin/bash
#SBATCH --job-name=female_outfit1
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
exp_comment=`date +%s`
run_name="SelfreconSynthesis-female_outfit1_${exp_comment}_slurm_${user_comment}"
base_exp_dir="exp/${run_name}"
conf="confs/hfavatar-selfrecon_synthesis/SelfreconSynthesis-female-outfit1-mono-4gpus.conf"
