...
exp_comment=`date +%s`
run_name="SelfreconSynthesis-male_outfit1_${exp_comment}_slurm_${user_comment}"
base_exp_dir="exp/${run_name}"
conf="confs/hfavatar-selfrecon_synthesis/SelfreconSynthesis-male-outfit1-mono-4gpus.conf"
